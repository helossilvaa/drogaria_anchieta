        ...
        {abrirModal && (
          <div className="fixed inset-0 flex justify-center items-center bg-black/30 shadow-inner z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-7 relative max-h-[90vh] overflow-y-auto animate-fadeIn">
              ...
              <h2 className="text-xl font-bold text-[#79b0b0] tracking-wide">
                Novo Filiado
              </h2>
              <hr className="border-[#79b0b0]/40 mb-5 mt-3" />
              <form onSubmit={handleSubmit} className="flex flex-col gap-3">
                {[
                  ...
                  <div key={name}>
                    <input
                      ...
                      className="p-3 mb-4 w-full bg-gray-100 border rounded-lg focus:border-[#79b0b0] transition outline-none"
                      placeholder={label}
                      required />
                  </div>
                ))}
                ...
                <div className="flex justify-end mt-6">
                  <button
                    type="submit"
                    className="bg-[#79b0b0] text-white px-5 py-2.5 rounded-lg hover:bg-[#64c7c7] transition transform hover:scale-[1.03] active:scale-95 shadow-md">
                    Salvar
                  </button>
                </div>
              </form>
        ...
        {abrirModalEditar && (
          <div className="fixed inset-0 flex justify-center items-center bg-black/30 shadow-inner z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg p-7 relative max-h-[90vh] overflow-y-auto animate-fadeIn">
              ...
              <h2 className="text-xl font-bold text-[#79b0b0] tracking-wide text-left">
                Editar Usuário
              </h2>
              <hr className="border-[#79b0b0]/40 mb-5 mt-3" />
                    ...
                    return (
                      <div key={key}>
                        <input
                          ...
                          onChange={handleChange}
                          className="p-3 mb-4 w-full bg-gray-100 border rounded-lg focus:ring-2 focus:ring-[#79b0b0] focus:border-[#79b0b0] transition outline-none"
        ...
        {abrirModalExcluir && (
          <div className="fixed inset-0 flex justify-center items-center bg-black/30 shadow-inner z-50 p-4">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm p-7 max-h-[90vh] overflow-y-auto animate-fadeIn relative">
              ...
              <h2 className="text-xl font-bold text-[#64c7c7] tracking-wide text-left">
                Confirmar Exclusão
              </h2>
              <hr className="border-[#64c7c7]/40 mb-5 mt-3" />
              ...
              {usuariosFiltrados.length > itensPorPagina && (
                <div className="flex justify-center items-center gap-2 mt-4 select-none">
                  <button
                    ...
                    className="px-4 py-2 rounded-full border border-[#64c7c7] text-[#79b0b0] hover:bg-gray-100 hover:text-[#79b0b0] transition-all disabled:opacity-50 disabled:cursor-not-allowed">
                    ← Anterior
                  </button>
                  <div className="px-4 py-2 rounded-full text-white bg-[#79b0b0]">
                    {paginaAtual}
                  </div>
                  <button
                    onClick={() => mudarPagina(paginaAtual + 1)}
